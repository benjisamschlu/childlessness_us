...
##
##  This code estimate proportion of childless mother by race/ethnicity
        ...
        df.i |> 
                left_join(
                        df.stan |> 
                                ...
                                dplyr::select(
                                        race_i, cohort_i, age_i, obs_i
                                ),
                        by = c("race_i", "cohort_i", "age_i")
                ) |> 
                filter(
                        !is.na(obs_i)
                ) |> 
